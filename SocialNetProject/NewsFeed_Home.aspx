<%@ Page Title="" Language="C#" MasterPageFile="~/NewsFeed.Master" AutoEventWireup="true" CodeBehind="NewsFeed_Home.aspx.cs" Inherits="SocialNetProject.NewsFeed_Home" %>
                ...
                <div class="user-post">
                    <div class="friend-info">
                        ...
                        <div class="friend-name">
                            <ins>
                                <asp:LinkButton ID="LinkButton1" CommandName="viewFriend" CommandArgument='<%# Eval("users_id") %>' runat="server"><%# Eval("full_name") %></asp:LinkButton></ins>
